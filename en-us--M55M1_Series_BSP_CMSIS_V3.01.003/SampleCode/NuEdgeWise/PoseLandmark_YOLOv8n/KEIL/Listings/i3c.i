# 1 "C:/Keil_v5/Packs/Nuvoton/NuMicroM55_DFP/3.1.4-rc.3/Library/StdDriver/src/i3c.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 401 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Keil_v5/Packs/Nuvoton/NuMicroM55_DFP/3.1.4-rc.3/Library/StdDriver/src/i3c.c" 2
# 10 "C:/Keil_v5/Packs/Nuvoton/NuMicroM55_DFP/3.1.4-rc.3/Library/StdDriver/src/i3c.c"
...
# 11 "C:/Keil_v5/Packs/Nuvoton/NuMicroM55_DFP/3.1.4-rc.3/Library/StdDriver/src/i3c.c" 2
# 41 "C:/Keil_v5/Packs/Nuvoton/NuMicroM55_DFP/3.1.4-rc.3/Library/StdDriver/src/i3c.c"
void I3C_Open(I3C_T *i3c,
              uint32_t u32MasterSlave,
              uint8_t u8StaticAddr,
              uint32_t u32ModeSel)
{
    i3c->DEVCTLE = u32MasterSlave;
    ...
    if (u32MasterSlave == (0x0U << (0U)))
    {

        i3c->DEVADDR = ((u8StaticAddr << (0U)) | (1UL << (15U)))
                       | ((u8StaticAddr << (16U)) | (1UL << (31U)));
        return;
    }
    ...
    {
        i3c->DEVADDR &= ~(0x7FUL << (0U));
        i3c->DEVADDR |= ((1UL << (15U)) | u8StaticAddr);
    }
    ...
    else if (u32ModeSel == (1UL))
    {

        i3c->DEVCTL |= (1UL << (27U));
        i3c->SLVEVNTS |= (1UL << (3U));
    }
    else if (u32ModeSel == (2UL))
    {
...
# 116 "C:/Keil_v5/Packs/Nuvoton/NuMicroM55_DFP/3.1.4-rc.3/Library/StdDriver/src/i3c.c"
int32_t I3C_ResetAndResume(I3C_T *i3c, uint32_t u32ResetMask, uint32_t u32EnableResume)
{
    uint8_t u8InHaltState = 0;
    volatile uint32_t u32Timeout;

    if (((((i3c)->CCCDEVS&(1UL << (9U)))==0)? 0:1))
    {
        u8InHaltState = 1;
    }
    ...
    if (u32EnableResume || u8InHaltState)
    {
        ...
        while ((i3c->DEVCTL & (1UL << (30U))) == (1UL << (30U))) {}
...
# 186 "C:/Keil_v5/Packs/Nuvoton/NuMicroM55_DFP/3.1.4-rc.3/Library/StdDriver/src/i3c.c"
int32_t I3C_ParseRespQueue(I3C_T *i3c, uint32_t *pu32RespQ)
{
    ...
    if (((((i3c)->QUESTSLV&(0xFFUL << (8U)))==0)? 1:0))
    {
        return (-4L);
    }

    u8RespQCnt = (((i3c)->QUETHCTL&(0xFFUL << (8U))) >> (8U)) + 1;
    qn = 0;

    do
    {
        pu32RespQ[qn] = ((i3c)->RESPQUE);

        if (!((((pu32RespQ[qn])&(0xFUL << (28U)))==0)? 1:0))
        {
            return (pu32RespQ[qn] & (0xFUL << (28U)));
        }
...
# 236 "C:/Keil_v5/Packs/Nuvoton/NuMicroM55_DFP/3.1.4-rc.3/Library/StdDriver/src/i3c.c"
int32_t I3C_SetCmdQueueAndData(I3C_T *i3c, uint8_t u8TID, uint32_t *pu32TxBuf, uint16_t u16WriteBytes)
{
    uint32_t i;


    if (u16WriteBytes > ((32UL) * 4))
    {
        return (-1000L);
    }


    if (((((i3c)->QUESTSLV&(0xFFUL << (0U)))==0)? 1:0))
    {
        return (-3L);
    }
    ...
    if (pu32TxBuf != 0)
    {
        for (i = 0; i < ((u16WriteBytes + 3) / 4); i++)
        {
            ...
            if (((((i3c)->DBSTSLV&(0xFFUL << (0U)))==0)? 1:0))
            {
                return (-2L);
            }
    ...
    i3c->CMDQUE = ((u8TID << (3U)) | (u16WriteBytes << (16U)));
    return (0L);
}
# 284 "C:/Keil_v5/Packs/Nuvoton/NuMicroM55_DFP/3.1.4-rc.3/Library/StdDriver/src/i3c.c"
int32_t I3C_SendIBIRequest(I3C_T *i3c, uint8_t u8MandatoryData, uint32_t u32PayloadData, uint8_t u8PayloadLen)
{
    ...
    i3c->SIR = (u8PayloadLen << (16U)) | (u8MandatoryData << (8U)) | (0 << (1U));
...
# 323 "C:/Keil_v5/Packs/Nuvoton/NuMicroM55_DFP/3.1.4-rc.3/Library/StdDriver/src/i3c.c"
int32_t I3C_SendMRRequest(I3C_T *i3c)
{
...
# 353 "C:/Keil_v5/Packs/Nuvoton/NuMicroM55_DFP/3.1.4-rc.3/Library/StdDriver/src/i3c.c"
int32_t I3C_DisableHJRequest(I3C_T *i3c)
{
...
# 372 "C:/Keil_v5/Packs/Nuvoton/NuMicroM55_DFP/3.1.4-rc.3/Library/StdDriver/src/i3c.c"
int32_t I3C_RespErrorRecovery(I3C_T *i3c, uint32_t u32RespStatus)
{
    if (u32RespStatus != (0L))
    {
        if (((((i3c)->CCCDEVS&(1UL << (9U)))==0)? 0:1))
        {
            switch (u32RespStatus)
            {
                ...
                case (6UL << (28U)):
                    ...
                    I3C_ResetAndResume(i3c, ((1UL << (4U))), (1UL));
                    break;

                case (10UL << (28U)):

                    I3C_ResetAndResume(i3c, (((1UL << (3U))) | ((1UL << (1U)))), (1UL));
                    break;

                default:

                    I3C_ResetAndResume(i3c, ((1UL << (0U))), (0UL));
                    break;
            }
        }
    }
...
# 422 "C:/Keil_v5/Packs/Nuvoton/NuMicroM55_DFP/3.1.4-rc.3/Library/StdDriver/src/i3c.c"
int32_t I3C_SetDeviceAddr(I3C_T *i3c, uint8_t u8DevIndex, uint8_t u8DevType, uint8_t u8DAddr, int8_t u8SAddr)
{
    ...
    if ((count % 2) == 0)
    {
        u32Device = ((u8DAddr | 0x80) << (16U));
    }
    else
    {
        u32Device = (u8DAddr << (16U));
    }


    u32Device |= (u8SAddr << (0U));
...
# 525 "C:/Keil_v5/Packs/Nuvoton/NuMicroM55_DFP/3.1.4-rc.3/Library/StdDriver/src/i3c.c"
int32_t I3C_Write(I3C_T *i3c, uint8_t u8DevIndex, uint32_t u32Speed, uint32_t *pu32TxBuf, uint16_t u16WriteBytes)
{
    uint32_t i;
    ...
    if ((u16WriteBytes == 0) || (pu32TxBuf == 0))
    {
        return (-1000L);
    }
    ...
    if (u16WriteBytes <= 3)
    {
        i3c->CMDQUE = (((pu32TxBuf[0] & 0x00FFFFFF) << (8U))
                       | ((((1 << u16WriteBytes) - 1) & 0x07) << (3U))
                       | 0x2);
        ...
        i3c->CMDQUE = ((0x1UL << (30U)) | (0x1UL << (27U)) | (0x1UL << (26U))
                       | (u32Speed & (0x7UL << (21U)))
                       | ((u8DevIndex & 0x1F) << (16U))
                       | (0x05 << (3U))
                       | 0x0);
    ...
    {
        i3c->CMDQUE = ((u16WriteBytes << (16U)) | 0x1);
        ...
        i3c->CMDQUE = ((0x1UL << (30U)) | (0x1UL << (26U))
                       | (u32Speed & (0x7UL << (21U)))
                       | ((u8DevIndex & 0x1F) << (16U))
                       | (0x05 << (3U))
                       | 0x0);
        ...
        for (i = 0; i < ((u16WriteBytes + 3) / 4); i++)
        {
            ...
            while (((((i3c)->DBSTSLV&(0xFFUL << (0U)))==0)? 1:0))
            {
    ...
    while ((i3c->INTSTS & (1UL << (4U))) == 0);

    response = i3c->RESPQUE;

    if (response & (0xFUL << (28U)))
    {
        i3c->DEVCTL |= (1UL << (30U));
        return (-2000L);
    }
...
# 635 "C:/Keil_v5/Packs/Nuvoton/NuMicroM55_DFP/3.1.4-rc.3/Library/StdDriver/src/i3c.c"
int32_t I3C_Read(I3C_T *i3c, uint8_t u8DevIndex, uint32_t u32Speed, uint32_t *pu32RxBuf, uint16_t u16ReadBytes)
{
    uint32_t i;
    ...
    i3c->CMDQUE = ((u16ReadBytes << (16U)) | 0x1);
    ...
    i3c->CMDQUE = ((0x1UL << (30U)) | (0x1UL << (28U)) | (0x1UL << (26U))
                   | (u32Speed & (0x7UL << (21U)))
                   | ((u8DevIndex & 0x1F) << (16U))
                   | (0x03 << (3U))
                   | 0x0);
    ...
    if ((response & (0xFUL << (28U))) != (0UL << (28U)))
    {
        return (-2000L);
    }

    response = ((response & (0xFFFFUL << (0U))) + 3) / 4;
...
# 705 "C:/Keil_v5/Packs/Nuvoton/NuMicroM55_DFP/3.1.4-rc.3/Library/StdDriver/src/i3c.c"
int32_t I3C_BroadcastRSTDAA(I3C_T *i3c)
{
    uint32_t response;
    i3c->CMDQUE = ((0 << (16U)) | 0x1);
    i3c->CMDQUE = ((0x1UL << (30U)) | (0x1UL << (26U))
                   | (1UL << (15U))
                   | ((((0x6) | (((1UL)) ? 0 : 0x00000080)) << (7U)) & (0xFFUL << (7U)))
                   | 0x0);
...
# 739 "C:/Keil_v5/Packs/Nuvoton/NuMicroM55_DFP/3.1.4-rc.3/Library/StdDriver/src/i3c.c"
int32_t I3C_BroadcastENTDAA(I3C_T *i3c, uint8_t u8DevCount)
{
    uint32_t response, error;
    i3c->CMDQUE = ((0x1UL << (30U)) | (0x1UL << (26U))
                   | (0 << (16U))
                   | ((u8DevCount << (21U)) & (0x1FUL << (21U)))
                   | (((0x7) | (((1UL)) ? 0 : 0x00000080)) << (7U))
                   | 0x3);

    while ((i3c->INTSTS & (1UL << (4U))) == 0);

    response = i3c->RESPQUE;
    error = (response & (0xFUL << (28U)));

    if (i3c->INTSTS & (1UL << (9U)))
    {
        i3c->INTSTS |= (1UL << (9U));
    }
    ...
    else if (error == (4UL << (28U)))
    {
        ...
        return (u8DevCount - (response & (0xFFFFUL << (0U))));
    }
    else
    {
        i3c->DEVCTL |= (1UL << (30U));
...
# 793 "C:/Keil_v5/Packs/Nuvoton/NuMicroM55_DFP/3.1.4-rc.3/Library/StdDriver/src/i3c.c"
int32_t I3C_UnicastSETDASA(I3C_T *i3c, uint8_t u8DevIndex)
{
    uint32_t response;
    i3c->CMDQUE = ((0x1UL << (30U)) | (0x1UL << (26U))
...
# 830 "C:/Keil_v5/Packs/Nuvoton/NuMicroM55_DFP/3.1.4-rc.3/Library/StdDriver/src/i3c.c"
int32_t I3C_UnicastGETACCMST(I3C_T *i3c, uint8_t u8DevIndex, uint32_t *pu32RxBuf)
{
    uint32_t i, cmd, response, data;
    i3c->CMDQUE = ((1 << (16U)) | 0x1);

    cmd = ((0x1UL << (30U)) | (0x1UL << (26U))
           | ((u8DevIndex & 0x1F) << (16U))
           | (0x1UL << (28U))
           | (1UL << (15U)) | (((0x11) | (((0UL)) ? 0 : 0x00000080)) << (7U))
           | 0x0);
    i3c->CMDQUE = cmd;

    while ((((I3C_T *) ((((uint32_t) 0x40000000UL) + 0x00290000UL) + 0x0A000UL))->INTSTS & (1UL << (4U))) == 0);

    response = ((I3C_T *) ((((uint32_t) 0x40000000UL) + 0x00290000UL) + 0x0A000UL))->RESPQUE;

    if (response & (0xFUL << (28U)))
    {
        ((I3C_T *) ((((uint32_t) 0x40000000UL) + 0x00290000UL) + 0x0A000UL))->DEVCTL |= (1UL << (30U));
    }
    ...
    if (response != 0)
    {
        for (i = 0; i < response; i++)
        {
            data = ((I3C_T *) ((((uint32_t) 0x40000000UL) + 0x00290000UL) + 0x0A000UL))->TXRXDAT;
