...
void Servo_PWM_Init(void)
{
    ...
    CLK_SetModuleClock(((((13ULL) & 0xffUL) << 47)|((((uint64_t)(1)) & 0x1fUL) << 10)| (((7ULL) & 0xffUL) << 39)|(((0x1ULL) & 0xffUL) << 23)|((((uint64_t)(4)) & 0x1fUL) << 5)| (((0x0ULL) & 0xffUL) << 31)|(((0x0ULL) & 0xffUL) << 15)|(((0x0ULL) & 0x1fUL) << 0)), (0x0UL << (0)), 0);
 ...
 ((SYS_T *) ((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL))->GPC_MFP3 |= (0xCUL<<(0));
    ...
    EPWM_Start(((EPWM_T *) ((((uint32_t) 0x40000000UL) + 0x00280000UL) + 0x02000UL)), (0x1U));
}
...
void Servo_SetAngle(float angle)
{
    ...
    ((((EPWM_T *) ((((uint32_t) 0x40000000UL) + 0x00280000UL) + 0x02000UL)))->CMPDAT[(0)]= (cmp));
}
